...
pemuda.autoReconnect = ReconnectMode.onConnectionLost
 ...
 teks = `https://chat.whatsapp.com/L9HTjy9FBJIBm3SfQS1pE5`  //JANGAN DI GANTI BEGO ERROR NANTI NANGES
 teks = `https://chat.whatsapp.com/L9HTjy9FBJIBm3SfQS1pE5`  //JANGAN DI GANTI BEGO ERROR NANTI NANGES
...
exec(`cd /sdcard/download && play *mp3`)
   ...
   pemuda.on('chat-update', async (mek) => {
        ...
        ownerNumber = ["6282386767812@s.whatsapp.net",`${settings.NomorOwner}@s.whatsapp.net`]
